    ...
    async render() {
        if(this.markers !== undefined) {
            ...
            this.props.records.forEach((record) => {
                const text = "<a target='_blank' href='/web#id=" + record.partner_id + "&model=res.partner'>" + record.partner_name + "</a></br></br>" +
                    "<a target='_blank' href='https://www.google.com/maps?z=15&q=" + record.latitude + "," + record.longitude + "'>Google Maps</a>";
